...
«Автовыбор модели» в v3 = **policy** в orchestrator + алиасы в LiteLLM; для жюри — формулировка из [PITCH-DEMO.md](PITCH-DEMO.md).
...
Зафиксировать в [PITCH-DEMO.md](PITCH-DEMO.md):
